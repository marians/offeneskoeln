...
# Basis Host
BASE_HOST = 'bottrop.ris.openruhr.de'
...
CITY_NAME_ER = 'Bottroper'


# The name of the website. Use unicode!
#APP_NAME = u'Offenes K\xf6ln'
APP_NAME = u'OpenRuhr:RIS:Bottrop'

APP_TAGLINE = u'Die Lokalpolitik in Bottrop, einfach zug\xe4nglich'
...
DISQUS_SHORTNAME = 'openruhr-ris-bottrop'
...
MAP_START_POINT = [6.944689, 51.529086]
