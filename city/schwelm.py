...
# Basis Host
BASE_HOST = 'schwelm.ris.openruhr.de'
...
LOCATION_NAME = 'Schwelm'

#Name der Stadt
CITY_NAME = 'Schwelm'
#Name der Stadt für Beschreibungen wie "Bochumer Kommunalpolitik"
CITY_NAME_ER = 'Schwelmer'


# The name of the website. Use unicode!
#APP_NAME = u'Offenes K\xf6ln'
APP_NAME = u'OpenRuhr:RIS:Schwelm'

APP_TAGLINE = u'Die Lokalpolitik in Schwelm, einfach zug\xe4nglich'
...
DISQUS_SHORTNAME = 'openruhr-ris-schwelm'
...
RIS_ORIGINAL_URL = 'http://ratsinfo.schwelm.de/sessionnet/bi/'
#URL der Geschäftsordnung
GESCHAEFTSORDNUNG_URL = 'http://www.schwelm.de/fileadmin/user_upload/public/docs/ortsrecht/10_2_GeschO_Rat.pdf'
