...
LOCATION_NAME = 'Berlin Friedrichshain-Kreuzberg'

#Name der Stadt
CITY_NAME = 'Berlin Friedrichshain-Kreuzberg'
#Name der Stadt für Beschreibungen wie "Bochumer Kommunalpolitik"
CITY_NAME_ER = 'Berlin Friedrichshain-Kreuzberger'


# The name of the website. Use unicode!
#APP_NAME = u'Offenes K\xf6ln'
APP_NAME = u'OpenRuhr:RIS:Berlin Friedrichshain-Kreuzberg'

APP_TAGLINE = u'Die Lokalpolitik in Berlin Friedrichshain-Kreuzberg, einfach zug\xe4nglich'
...
MAP_START_POINT = [13.431419, 52.499567,]
...
GEOCODING_DEFAULT_CITY = 'Berlin'
GEOCODING_DEFAULT_COUNTRY = 'DE'
GEOCODING_FILTER_COUNTY = 'Berlin'
...
ES_INDEX_NAME_PREFIX = 'ris-web-berlin-friedrichshain-kreuzberg'
